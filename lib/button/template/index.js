...
module.exports = function(m){
  ...
  const a = `<svg ${icon_style} id="${m.widgetId}-icon" data-hide="yes" class="inner drumee-picto ${m.innerClass}"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#--icon-${chartId}"></use></svg><div ${text_style} id="${m.widgetId}-label" class="${m.innerClass} inner note-content">${label}</div>`;
  return _.template(a);
};
